...
# +-------------------------------------------------------------------
# +-------------------------------------------------------------------
namespace sower\template\taglib;

use sower\template\TagLib;
...
class Cx extends Taglib
{
    ...
    public function tagVolist(array $tag, string $content): string
    {
        ...
        $parseStr .= 'if(is_array(' . $name . ') || ' . $name . ' instanceof \sower\Collection || ' . $name . ' instanceof \sower\Paginator): $' . $key . ' = 0;';
    ...
    public function tagForeach(array $tag, string $content): string
    {
        ...
        $parseStr .= 'if(is_array(' . $name . ') || ' . $name . ' instanceof \sower\Collection || ' . $name . ' instanceof \sower\Paginator): ';
    ...
    public function tagEmpty(array $tag, string $content): string
    {
        $name     = $tag['name'];
        $name     = $this->autoBuildVar($name);
        $parseStr = '<?php if(empty(' . $name . ') || ((' . $name . ' instanceof \sower\Collection || ' . $name . ' instanceof \sower\Paginator ) && ' . $name . '->isEmpty())): ?>' . $content . '<?php endif; ?>';
